	...
	peers: [
		{
			...
			endpoint_transport: "xhttp_reality_fallback",
		...
		},
		{
			...
			stale: false,
			breaker: "open",
			direct_validation: "transport_failed",
			public_circuit: "closed",
		...
		},
		{
			...
			stale: false,
			breaker: "disabled",
			direct_validation: "configured_unverified",
			public_circuit: "closed",
			last_sample_at: null,
...
export const demoReverseMeshStatus: AdminMeshStatus = {
	...
	peers: [
		...
		},
		{
			...
			endpoint_transport: "xhttp_reality_fallback",
			reverse_relay_state: "disabled_pending_rework",
			active_route: {
				kind: "reality_direct",
				readiness: "direct_active",
			},
			reverse_underlay: {
				logical_links: 1,
	...
	events: [
		{
			...
			kind: "transition",
			message:
				"Native Reverse topology retained for diagnosis; request routing is disabled.",
		},
