...
const endpointSchema = z.object({
	...
	mihomoSmuxMaxConnections: z.coerce
		.number()
		.int()
		.min(1, "Enter a value from 1 to 16.")
		.max(16, "Enter a value from 1 to 16."),
	mihomoSmuxMinStreams: z.coerce
		.number()
		.int()
		.min(1, "Enter a value from 1 to 64.")
		.max(64, "Enter a value from 1 to 64."),
	mihomoSmuxOnlyTcp: z.boolean(),
});
...
export function EndpointNewPage() {
	...
	const form = useForm<EndpointFormInput, unknown, EndpointFormValues>({
		...
		defaultValues: {
			...
			mihomoSmuxOnlyTcp: DEFAULT_MIHOMO_SMUX_CONFIG.only_tcp,
		},
	});
									...
									<div className="mt-4 space-y-4">
										...
										<div className="flex items-center gap-2">
											<Checkbox
												...
												onCheckedChange={(checked) =>
													form.setValue("mihomoSmuxEnabled", checked === true, {
														shouldDirty: true,
													})
												}
											/>
										...
										<div className="grid gap-4 md:grid-cols-2">
											...
											<div className="space-y-2">
												...
												{form.formState.errors.mihomoSmuxMinStreams?.message ? (
													<p className="text-xs text-destructive">
														{form.formState.errors.mihomoSmuxMinStreams.message}
													</p>
												) : null}
										...
										<div className="flex items-center gap-2">
											<Checkbox
												...
												onCheckedChange={(checked) =>
													form.setValue("mihomoSmuxOnlyTcp", checked === true, {
														shouldDirty: true,
													})
												}
											/>
