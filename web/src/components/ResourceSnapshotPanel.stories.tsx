	...
	details: {
		diagnostic: {
			...
			route_attempts: [
				{
					...
					observed_at: fixtureCatalog.timestamp.t20240101T000400(),
				...
				},
				{
					...
					observed_at: fixtureCatalog.timestamp.t20240101T000500(),
					request_id: fixtureCatalog.identifier.ulidA(),
					elapsed_ms: 5000,
					retry_count: 0,
				},
			...
			last_public_failure: {
				...
				acknowledgement: "not_observed",
				dispatch: "dispatched_no_verified_response",
				observed_at: fixtureCatalog.timestamp.t20240101T000600(),
