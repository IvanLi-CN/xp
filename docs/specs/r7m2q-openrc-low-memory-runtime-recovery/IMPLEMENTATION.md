...
- During managed runtime activation, `xp-ops upgrade` stops XP and confirms the init manager
  reports it stopped before changing configuration or restarting Xray/cloudflared. It starts XP
  only after both runtime services report ready.
