...
| ----: | ------------------------------------------ | ------ | ---------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| xm43j | Geo DB 自更新与设置页                      | 已完成 | `xm43j-ip-geo-db-auto-update/SPEC.md`          | 2026-03-09 | PR #103；DB-IP Lite managed updater、cluster settings page、external override 兼容、hot refill                                                                                                                         |
| 6e7e4 | 节点 / 用户入站 IP 使用详情                | 已完成 | `6e7e4-node-user-inbound-ip-usage/SPEC.md`     | 2026-03-09 | PR #102；checks green；mergeable clean；API/Xray/ops docs synced；ECharts/storybook/user-tab/highlight follow-up closed；review clear                                                                                  |
