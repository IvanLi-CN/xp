...
| 3e4q4 | Mihomo provider-only 动态链式订阅          | 已完成 | `3e4q4-mihomo-provider-dual-track/SPEC.md`              | 2026-06-16 | provider-only route；transit-only 地区桶 + 单层低频 relay url-test；relay 无候选时主配置与 system payload 同步裁 chain                                                                                                                                                                                                                            |
