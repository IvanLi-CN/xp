...
| ----: | ------------------------------------------ | ------ | ---------------------------------------------- | ---------- | ----------------------------------- |
| puf2g | Node panel icon-only entry for node lists  | 已完成 | `puf2g-node-panel-link-entry/SPEC.md`          | 2026-03-01 | local implementation + tests passed |
...
| wvrmn | Remove grants hard cut                     | 已完成 | `wvrmn-remove-grants-hard-cut/SPEC.md`         | 2026-03-01 | PR #86                              |
