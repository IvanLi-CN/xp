...
| ----: | ------------------------------------------ | ------ | ---------------------------------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| xm43j | Geo DB 自更新与设置页                      | 已完成 | `xm43j-ip-geo-db-auto-update/SPEC.md`          | 2026-03-09 | DB-IP Lite managed updater、cluster settings page、external override 兼容、hot refill                                                                                                                                  |
