...
| ----: | ------------------------------------------ | ------ | ---------------------------------------------- | ---------- | ---------------------------------------------------------------------- |
| gj4xg | Dashboard/Nodes shared node inventory list | 已完成 | `gj4xg-dashboard-nodes-shared-list/SPEC.md`    | 2026-03-03 | PR #93 + checks green + review-loop fix (`ResizeObserver` fallback)    |
