...
| rbt5e | 用户订阅 Mihomo 混入配置                   | 已完成 | `rbt5e-mihomo-subscription-template/SPEC.md`            | 2026-06-19 | PR #100 后续单链降载修订；`mixin_yaml` API、`🛣️ JP/HK/TW` 外层候选组、probe-derived 固定地区面、`💎 高质量` / `🚀 节点选择` 自动补点、系统托管引用清洗                                                                                                                                                                                             |
