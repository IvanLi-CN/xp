...
| 3e4q4 | Mihomo provider-only 动态链式订阅          | 已完成 | `3e4q4-mihomo-provider-dual-track/SPEC.md`              | 2026-05-02 | provider-only route；系统 provider 动态输出直连与 `*-ss-chain` / `*-reality-chain`；主配置通过 provider filter 消费链式候选                                                                                                                                                                                                                       |
