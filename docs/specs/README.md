...
| 3e4q4 | Mihomo 双轨订阅（legacy 默认 + provider 并行） | 已完成 | `3e4q4-mihomo-provider-dual-track/SPEC.md`              | 2026-04-17 | dual-track route + persistent admin setting + provider payload landed；Storybook/real Mihomo validation synced                                                                                                                                                                                                                                    |
