...
|       |                                            |        |                                                       |            |                                                                                                                                                                                                                        |
| 6e7e4 | 节点 / 用户入站 IP 使用详情                | 已完成 | `6e7e4-node-user-inbound-ip-usage/SPEC.md`            | 2026-03-11 | PR #102/#110；checks green；mergeable clean；API/Xray/ops docs synced；ECharts/storybook/user-tab/highlight follow-up closed；header highlight badge contrast follow-up；review clear                                  |
