...
| tc2kp | country.is Hosted IP Geo hard cut          | 已完成 | `tc2kp-country-is-ip-geo/SPEC.md`                     | 2026-03-10 | 免费无门槛 hosted API hard cut；移除 MMDB/DB-IP 更新面与 `/ip-geo-db`                                                                                                                                                                                                                  |
...
|       |                                            |        |                                                       |            |                                                                                                                                                                                                                                                                                        |
| 6e7e4 | 节点 / 用户入站 IP 使用详情                | 已完成 | `6e7e4-node-user-inbound-ip-usage/SPEC.md`            | 2026-03-12 | PR #102/#110；checks green；mergeable clean；API/Xray/ops docs synced；ECharts/storybook/user-tab/highlight follow-up closed；header highlight badge contrast follow-up（light/dark）+ visual evidence synced；AA contrast regression guard added（prefix + value text）；review clear |
...
| rbt5e | 用户订阅 Mihomo 混入配置                   | 已完成 | `rbt5e-mihomo-subscription-template/SPEC.md`          | 2026-03-08 | PR #100 后续单链降载修订；`mixin_yaml` API、`🛣️ JP/HK/TW` 外层候选组、`-chain` 单链回落、共享测试机证据（示例输出 + provider-only `mihomo -t`）、review fixes（extra-only landing prune + explicit extra ref preserve）                                                                 |
...
| e5sqd | 前端 Tools 入口 + Mihomo 订阅脱敏         | 部分完成（3/4） | `e5sqd-web-tools-mihomo-redact/SPEC.md`               | 2026-03-19 | fast-track                                                                                                                                                                                                                                                                             |
