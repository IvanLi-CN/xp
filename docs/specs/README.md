...
| 3e4q4 | Mihomo 双轨订阅（legacy 默认 + provider 并行） | 已完成 | `3e4q4-mihomo-provider-dual-track/SPEC.md`              | 2026-04-24 | dual-track route + persistent admin setting + provider payload landed；provider 主配置地区组改为 probe-derived 固定地区面并补 `🌟 Other`                                                                                                                                                                                                          |
